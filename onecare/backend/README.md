...
- Send notifications to a topic (broadcast to subscribed devices)
...
**Request Body** (data-only; client formats dates/localizes):
```json
{
  "type": "maintenance",
  "topic": "maintenance",
  "startAt": "2026-01-20T22:00:00Z",
  "endAt": "2026-01-20T23:00:00Z"
}
```
...
**General Info Request Body** (data-only; client localizes title):
```json
{
  "type": "general",
  "topic": "maintenance",
  "body": "Maintenance completed. All systems are operational."
}
```
...
6. Your backend can now send notifications using:
   ...
   - `/api/notifications/send-to-topic` - Send to a topic
