...
public class TokenStorageService {
    ...
    /**
     * Get all tokens except for a specific user (for notifications where the action performer should be excluded)
     */
    public List<String> getAllTokensExceptUser(String excludeUserId) {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            LOGGER.severe("Failed to fetch tokens excluding user " + excludeUserId + ": " + e.getMessage());
        }
        return result;
    }
