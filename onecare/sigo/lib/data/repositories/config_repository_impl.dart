...
class ConfigRepositoryImpl implements ConfigRepository {
  ...
  Future<String?> _getEncryptionKey() async {
    // Always fetch from Firestore to get the latest key
    try {
  ...
  Future<bool> saveConfigFromQrCode(String qrData) async {
    try {
      ...
      if (encryptionKey == null) {
        ...
        throw const FormatException('Encryption key not available. Check your network connection.');
      }
      ...
      if (decryptedJson == null) {
        ...
        throw const FormatException('Failed to decrypt QR code. Invalid or corrupted data.');
      }
