...
class AppNotification {
  ...
  final bool read;
  final bool isTopicNotification;
  final String? topic;
  ...
  AppNotification({
    ...
    DateTime? receivedAt,
    this.read = false,
    this.isTopicNotification = false,
    this.topic,
  ...
  AppNotification copyWith({
    ...
    return AppNotification(
      ...
      read: read ?? this.read,
      isTopicNotification: isTopicNotification,
      topic: topic,
    );
  }
  ...
  factory AppNotification.fromRemoteMessage(
    ...
    // Check if notification is from a topic
    final from = message.from;
    final isFromTopic = from != null && from.startsWith('/topics/');
    final topicName = isFromTopic ? from.replaceFirst('/topics/', '') : null;
    ...
    return AppNotification(
      ...
      read: read,
      isTopicNotification: isFromTopic,
      topic: topicName,
    );
  }
  ...
  factory AppNotification.fromMap(Map<String, dynamic> map) {
    return AppNotification(
      ...
      isTopicNotification: (map['is_topic'] as int? ?? 0) == 1,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'read': read ? 1 : 0,
      'is_topic': isTopicNotification ? 1 : 0,
      'topic': topic,
    };
  }
}
