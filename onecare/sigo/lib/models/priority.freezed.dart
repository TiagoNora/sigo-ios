...
abstract class _$$PriorityImplCopyWith<$Res>
  ...
  factory _$$PriorityImplCopyWith(
    _$PriorityImpl value,
    $Res Function(_$PriorityImpl) then,
...
class __$$PriorityImplCopyWithImpl<$Res>
  ...
  __$$PriorityImplCopyWithImpl(
    _$PriorityImpl _value,
    $Res Function(_$PriorityImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$PriorityImpl extends _Priority {
  ...
  @override
  String toString() {
    return 'Priority(name: $name, level: $level, color: $color, translations: $translations, enabled: $enabled)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PriorityImplToJson(this);
  }
}
