...
class _LoginScreenState extends State<LoginScreen> {
  Future<void> _handleLogin() async {
    ...
    if (authRepository.isAuthenticated) {
      debugPrint('Already authenticated, manually navigating to home');
      // User is authenticated but stuck on login screen
      // Manually navigate to home screen
      if (mounted) {
    ...
    // Navigation to home is handled by AuthWrapper based on AuthBloc state
