...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (authRepository.isAuthenticated) {
      ...
      // If authenticated, the AuthWrapper will automatically rebuild and show home
    ...
    // After OAuth completes, let AuthWrapper handle the navigation
    // It will rebuild automatically when AuthBloc state changes to AuthAuthenticated
  }
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthAuthenticated) {
          // User just became authenticated, navigate to home
          Navigator.of(context).pushReplacementNamed(AppRoutes.home);
        }
      },
      child: Scaffold(
