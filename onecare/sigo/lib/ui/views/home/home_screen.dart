...
class HomeScreenState extends State<HomeScreen> with RouteAware, WidgetsBindingObserver {
  ...
  final FocusNode _searchFocusNode = FocusNode(debugLabel: 'HomeScreen_SearchField');
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const _SkeletonBar(width: 120, height: 12),
            const SizedBox(height: 12),
            const _SkeletonBar(width: double.infinity, height: 18),
