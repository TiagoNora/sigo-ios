                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildInfoRow(
                                ...
                                Icons.phone,
                                l10n.phone,
                                user.phone.trim().isEmpty ? '--' : user.phone,
                              ),
                              const SizedBox(height: 12),
                              _buildInfoRow(
                                context,
                              ...
                              // Team selection removed per requirement
                            ],
                          ),
                        ),
                      ),
...
class _SettingsScreenState extends State<_SettingsScreen> {
      ...
      body: Stack(
        children: [
          Container(
                        ...
                        onTap: () async {
                          ...
                          if (confirmed == true && context.mounted) {
                            ...
                            if (context.mounted) {
                              ...
                              // Pop all the way back to root (settings screen + any parent modals)
                          ...
                          if (confirmed == true && context.mounted) {
                            ...
                            try {
                              ...
                              if (context.mounted) {
                                ...
                                // Pop all the way back to root (settings screen + any parent modals)
                                Navigator.of(context).popUntil((route) => route.isFirst);
                                // AuthWrapper will handle navigation after config reset
                              }
                            } finally {
                              if (mounted) {
            ...
            // FCM Token in debug mode
            if (kDebugMode) ...[
              const SizedBox(height: 16),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: _buildFCMTokenCard(context),
              ),
            ],
            const SizedBox(height: 20),
              ],
  ...
  Widget _buildFCMTokenCard(BuildContext context) {
    ...
    return StreamBuilder<String?>(
      ...
      initialData: notificationService.fcmToken,
      builder: (context, snapshot) {
