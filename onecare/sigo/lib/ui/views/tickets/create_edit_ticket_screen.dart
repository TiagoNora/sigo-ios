...
class _CreateEditTicketScreenState extends State<CreateEditTicketScreen> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isLoadingTeams)
            Expanded(child: _buildTeamSkeletonList())
  ...
  Future<void> _loadAllCategories() async {
    try {
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context);
        BeautifulSnackbar.error(context, l10n.errorLoadingCategories);
      }
    }
  }
  ...
  Future<void> _loadSubcategories() async {
    ...
    try {
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context);
        BeautifulSnackbar.error(context, l10n.errorLoadingSubcategories);
      }
    }
  }
  ...
  Future<void> _loadImpactsAndSeverities() async {
    ...
    try {
      ...
      if (mounted) {
        final l10n = AppLocalizations.of(context);
        BeautifulSnackbar.error(context, l10n.errorLoadingImpactsAndSeverities);
      }
    }
  }
    ...
    try {
      ...
      if (mounted) {
        BeautifulSnackbar.error(
          context,
          AppLocalizations.of(context).errorSelectingFiles,
        );
      }
    }
  }
  ...
  Future<void> _createTicket() async {
    try {
      ...
      showDialog(
        ...
        builder: (context) => _buildCreateTicketLoadingDialog(context),
      );
      ...
      if (mounted) {
        BeautifulSnackbar.error(
          context,
          AppLocalizations.of(context).failedToCreateTicket,
        );
      }
    }
  }

  Widget _buildCreateTicketLoadingDialog(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    return Dialog(
