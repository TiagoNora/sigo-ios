...
class _TicketDetailScreenState extends State<TicketDetailScreen> {
  ...
  Future<void> _loadImpactsAndSeverities() async {
    ...
    await impactSeverityService.loadImpactsAndSeverities();
    if (mounted) setState(() {});
  }
  ...
  Future<void> _loadTicketDetails({bool forceRefresh = false}) async {
    ...
    try {
      ...
      if (forceRefresh) {
        ...
        ticket = await ticketRepository.getTicketById(widget.ticketId);
      }
      ...
      // Load logs and evaluate after ticket is loaded
      await Future.wait([
        _loadLogs(),
        _prefetchEvaluate(),
      ]);
  ...
  Future<void> _prefetchEvaluate() async {
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.noteAddedSuccessfully)));
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToAddNote}: $e')),
          );
        }
      }
    }
    ...
    if (result == true && controller.text.isNotEmpty) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.cancellingTicket)));
        }
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.ticketCancelledSuccessfully)),
          );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToCancelTicket}: $e')),
          );
        }
      }
    }
    ...
    if (result == true && controller.text.isNotEmpty) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.reopeningTicket)));
        }
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.ticketReopenedSuccessfully)),
          );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToReopenTicket}: $e')),
          );
        }
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l10n.justificationRequired)));
      }
    }
  }
    ...
    if (result == true) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.validatingTicket)));
        }
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.ticketValidatedSuccessfully)),
          );
          _loadTicketDetails(forceRefresh: true);
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToValidateTicket}: $e')),
          );
        }
      }
    }
  ...
  void _copyTicketUrl() {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text(l10n.ticketUrlCopied)));
  }
    ...
    try {
      if (!_canEditImpactUrgency) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Impact and urgency cannot be edited for this ticket.'),
            ),
          );
        }
        return;
      ...
      if (filteredImpacts.isEmpty) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.noImpactOptionsAvailable)),
          );
        }
        return;
      }
      ...
      if (selected != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.impactUpdatedSuccessfully)),
          );
          setState(() {
            _isLoading = true;
          });
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToUpdateImpact}: $e')),
        );
      }
    }
  }
  ...
  Future<void> _editUrgency() async {
    ...
    try {
      ...
      if (filteredSeverities.isEmpty) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.noUrgencyOptionsAvailable)),
          );
        }
        return;
      }
      ...
      if (selected != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(l10n.urgencyUpdatedSuccessfully)),
          );
          setState(() {
            _isLoading = true;
          });
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToUpdateUrgency}: $e')),
        );
      }
    }
  }
    ...
    return StreamBuilder<ConnectionStateStatus>(
      ...
      initialData: connectivity.status,
        ...
        return Scaffold(
          ...
          body: (_isLoading || _isLoadingLogs || _isEvaluating)
  ...
  Widget _buildGlobalInformationSection(AppLocalizations l10n) {
        ...
        child: Column(
          children: [
            ...
            if (hasEquipment) ...[
              ...
              _buildInfoRow(l10n.equipment, _getEquipmentName(l10n)),
              _buildInfoRow(l10n.equipmentType, _ticket!.ciType ?? l10n.na),
            ] else if (hasService) ...[
              _buildAffectedItemRow(
                l10n.service,
                FontAwesomeIcons.fileCircleMinus,
              ),
              _buildInfoRow(l10n.service, _getServiceName(l10n)),
              _buildInfoRow(l10n.serviceType, _getServiceType(l10n)),
            ],
            _buildCatalogRow(
              l10n.category,
              _ticket!.category,
    ...
    ([
                ...
                : (_ticket!.severity != null
                      ...
                      : _buildInfoRow(l10n.urgency, l10n.na)),
            _buildInfoRow(l10n.title, _ticket!.title),
            _buildInfoRow(l10n.description, _ticket!.description),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Dates
            _buildDateRow(l10n.reportedDate, _ticket!.createdAt),
            _buildDateRow(l10n.modifiedDate, _ticket!.updatedAt),
            _buildDateRow(l10n.limitDate, _ticket!.expectedResolutionDate),
            _buildDateRow(l10n.resolvedDate, _ticket!.resolvedAt),
            _buildDateRow(l10n.closedDate, _ticket!.closedDate),
          ],
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            if (_ticket!.apiNotes == null || _ticket!.apiNotes!.isEmpty)
              ...
              ..._ticket!.apiNotes!
                  .map((note) => _buildNoteItem(note, l10n))
                  .toList(),
            const SizedBox(height: 16),
            ...
            if (_ticket!.apiAttachments == null ||
              ...
              Text(l10n.noFilesAttached)
            else
              ..._ticket!.apiAttachments!.map(
            ...
            if (_isLogsExpanded) ...[
              ...
              if (_isLoadingLogs)
                ...
                ..._logs.map((log) => _buildLogItem(log, l10n)),
            ],
          ],
        ),
      ),
  ...
  Future<void> _downloadAttachment(Map<String, dynamic> attachment) async {
    ...
    try {
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l10n.downloadingFile)));
      }
      ...
      if (savePath == null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.downloadCancelled)));
        }
        return;
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l10n.fileSavedSuccessfully)));
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToDownloadFile}: $e')),
        );
      }
    }
  }
    ...
    if (confirmed == true) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.fileDeletedSuccessfully)));
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToDeleteFile}: $e')),
          );
        }
      }
    }
  ...
  Future<void> _uploadAttachment() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${l10n.failedToUploadFile}: $e')),
        );
      }
    }
  }
    ...
    if (result == true &&
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.noteUpdatedSuccessfully)));
          // Reload ticket details to get updated notes
          _loadTicketDetails();
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${l10n.failedToUpdateNote}: $e')),
          );
        }
      }
    }
  ...
  Widget _buildDateRow(String label, DateTime? date) {
    ...
    final value = date != null
        ? formatDate(date, locale.toString(), includeTime: true)
        : '--';
